    ...
    class App
    {
        ...
        public function render(IRequest $request)
        {
            ...
            try {
                ...
                $dispatcher->setRecurring(true);
                $dispatcher->setAction(function ($event) {
                    $event->xsrfId = $this->xsrfId;
                });
                Event::on('block/core/head', $dispatcher);
